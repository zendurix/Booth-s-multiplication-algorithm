...
namespace Booth_alorithm
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nnumbers converted to binary:\n"+bin1 + "\n"+bin2);
            Console.WriteLine("numbers converted to U2:\n" + Bin_to_U2(bin1) + "\n" + Bin_to_U2(bin2));

            string a = BOOTH(bin1, bin2);
            Console.WriteLine("result in decimal: " + U2_to_dec(a));
        ...
        static string BOOTH(string bin1, string bin2)
        {
            ...
            Console.WriteLine(" +M = " + plusM + "\n -M = " + minusM + "\n");
            string spaces = new string(' ', part1.Length);
            Console.WriteLine("           A" + spaces + "B" + spaces + "Q    OPERATIONS");
            ...
            for (int i = 1; i <= part1.Length; i++)
            {
                ...
                if (part2[part2.Length - 1] == '0' && q == '0')
                    Console.WriteLine("                 " + spaces + spaces + "00 -> SHIFT");
                else if (part2[part2.Length - 1] == '1' && q == '1')
                    Console.WriteLine("                 " + spaces + spaces + "11 -> SHIFT");
                else if (part2[part2.Length - 1] == '1' && q == '0')
                {
                    part1 = Bin_add(part1, minusM);
                    Console.WriteLine("      +" + minusM +"          " + spaces + "10 -> +(-M), SHIFT");
                    Console.WriteLine("      =" + part1);
                }
                else if (part2[part2.Length - 1] == '0' && q == '1')
                {
                    part1 = Bin_add(part1, plusM);
                    Console.WriteLine("      +" + plusM + "          " + spaces + "01 -> +M, SHIFT");
                    Console.WriteLine("      =" + part1);
                }
